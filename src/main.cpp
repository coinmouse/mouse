...
unsigned int nTargetSpacing = 4 * 60;
unsigned int nStakeMinAge = 60 * 60 * 24 * 1;
unsigned int nStakeMaxAge = 60 * 60 * 24 * 5;          
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // debug print
        // assert(block.hashMerkleRoot == uint256("0xa19abd6632650bde37a3feb35eef8ac6d1ffb70d5ce180b5e68b9eea13cb23ae"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xea, 0xa2, 0xd3 };
